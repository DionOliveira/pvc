        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a href="pesquisaajendamentos.php" class="nav-link">Consutar Agendamento</a></li>
                    <li class="nav-item active"><a href="pesquisarofcinas.php" class="nav-link">Consutar Oficinas</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>Oficinas Credenciadas <i class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Oficinas Credenciadas</h1>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="col d-flex">
                                <div class="contact-wrap w-100 p-md-5 p-4">
                                    <section class="ftco-appointment ftco-section   ">
                                        <h4>procure aqui a oficina </h4>
                                        <h4>mais perto de voçê.</h4>
                                        <div class="overlay"></div>
                                        <div class="container">
                                                    ...
                                                    <form class="appointment" method="POST">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <input type="submit" value="Pesquisar" class="btn btn-dark py-3 px-4">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    </form>
