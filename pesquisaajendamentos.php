        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active "><a href="pesquisaajendamentos.php" class="nav-link">Consutar Agendamento</a>
                    </li>
            ...
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Busca de Agendamentos <i
                                class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Busca de Agendamentos</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ftco-section bg-light">
        <div class="container">
                        ...
                        <div class="row no-gutters">
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb  ">
                                    <h4>Pesquise seus agendamentos </h4>
                                    <h4>atraves de seu CPF.</h4>
                                    <div class="overlay"></div>
                                    <div class="container">
            ...
            if ($cpf != 0){
                ...
                $dadosA = $objAgendamento->getDadoA($cpf);
                while ($registro = mysqli_fetch_array($dadosA)) {
                    $nome = $registro['nome'];
                    $placa = $registro['placa'];
                    $horario = $registro['horario'];
                    $data = $registro['data'];
                    $oficina = $registro['nome_ofi'];
                    $rua = $registro['rua'];
                    ...
                    echo '<li class="list-group-item"><center>' . $nome . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
                    echo '<li class="list-group-item"><center>' . $placa . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
                    echo '<li class="list-group-item"><center>' . $horario . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
                    echo '<li class="list-group-item"><center>' . $data . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
                    echo '<li class="list-group-item"><center>' . $oficina . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
                    echo '<li class="list-group-item"><center>' . $rua . ',  ' . $numero . '</center></li>';
                    echo '</ul>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<ul class="list-group">';
